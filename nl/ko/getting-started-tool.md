...
API에서 작업하는 것을 선호하는 경우 [API로 시작하기](/docs/services/discovery/getting-started.html)를 참조하십시오.
{: tip}
...
서비스 인스턴스를 작성했습니다. **관리**를 클릭한 후 **도구 열기**를 클릭하십시오. [단계 2](/docs/services/discovery/getting-started-tooling.html#create-a-collection)로 이동하십시오.
{: download tip}

{{site.data.keyword.discoveryshort}} 서비스 인스턴스를 작성한 경우 모든 전제조건이 충족됩니다. [단계 1](/docs/services/discovery/getting-started-tool.html#launch-the-tooling)로 이동하십시오.

1.  {{site.data.keyword.Bluemix_notm}} 카탈로그에서 [{{site.data.keyword.discoveryshort}} ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](https://console.{DomainName}/catalog/services/discovery){: new_window} 페이지로 이동하십시오.
...
{{site.data.keyword.discoveryshort}} 서비스 인스턴스를 작성하면 [{{site.data.keyword.Bluemix_notm}} 대시보드](https://console.{DomainName}/dashboard)가 나타납니다. {{site.data.keyword.discoveryshort}} 서비스 인스턴스를 클릭하여 {{site.data.keyword.discoveryshort}} 서비스 대시보드로 이동하십시오.

**관리** 페이지에서 **도구 열기**를 클릭하십시오. 

<!-- To do: Add screenshot for developer console -->

도구에 로그인하기 위한 프롬프트가 표시되는 경우 {{site.data.keyword.Bluemix_notm}} 인증 정보를 제공하십시오.
...
1.  사용자 환경이 준비되면 **사용자 데이터 업로드** 단추를 클릭한 후 **새 콜렉션 이름 지정**을 수행할 수 있습니다. 콜렉션의 이름을 지정하고 **적용할 구성 선택**에서 **기본 구성**을 선택하십시오(나중에 구성을 변경할 수 있음).

PDF의 요소에서 당사자, 네이처 및 카테고리를 추출하는 데 사용할 수 있는 요소 분류를 지원하는 **기본 계약 구성**이라는 사용 가능한 다른 구성이 있습니다. 세부사항은 [요소 분류](/docs/services/discovery/element-classification.html#element-collection)를 참조하십시오. 

또한 {{site.data.keyword.discoveryshort}} 도구를 사용하여 Box, Salesforce 및 Microsoft SharePoint Online 데이터 소스를 크롤링할 수도 있습니다. 자세한 정보를 보려면 **데이터 소스 연결** 단추를 클릭하고 [데이터 소스 연결](/docs/services/discovery/connect.html)을 참조하십시오.
{: tip}
