...
1.  Fai clic sull'icona di creazione delle query (**Build queries**) ![Icona Query](images/search_icon.svg)<!-- {width="20" height="20" style="padding-left:5px;padding-right:5px;"} --> per aprire la pagina della query. Seleziona la raccolta che contiene i comunicati stampa {{site.data.keyword.IBM_notm}} e fai clic su **Get started**.
