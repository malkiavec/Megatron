...
Domande frequenti sul servizio {{site.data.keyword.discoveryshort}}.

## Posso caricare gli array JSON?
{: #array} 

Puoi caricare un array JSON ma ciascuna sezione deve essere caricata singolarmente. Ad esempio, il seguente JSON non può essere caricato nel servizio:
    ...
    Per caricare queste informazioni nel servizio, suddividi l'array e carica ciascuna sezione, nel seguente modo:
