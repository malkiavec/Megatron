...
Vous avez créé votre instance de service. Cliquez sur **Manage**, puis sur **Launch Tool**. Accédez à l'[étape 2](/docs/services/discovery/getting-started-tooling.html#create-a-collection).
{: download tip}

Si vous avez créé un projet à l'aide du service {{site.data.keyword.discoveryshort}}, vous êtes prêt. Accédez à l'[étape 1](/docs/services/discovery/getting-started-tooling.html#launch-the-tooling).
...
Si vous utilisez {{site.data.keyword.Bluemix_dedicated_notm}}, créez votre instance de service à partir de la page [{{site.data.keyword.discoveryshort}} ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://console.{DomainName}/catalog/services/discovery/){: new_window} dans le catalogue. 
...
Après que vous avez créé un projet incluant le service {{site.data.keyword.discoveryshort}}, la page contenant les détails du projet s'affiche. Lancez les outils {{site.data.keyword.discoveryshort}} à partir de cette page. 

Cliquez sur **Lanch Tool** pour {{site.data.keyword.discoveryshort}} sous **Services**.
...
1.  Lorsque votre environnement est prêt, la boîte de dialogue **Name your new collection** s'affiche. Entrez un nom pour votre collection et choisissez **Default Configuration** dans la liste **Select a configuration to apply** (vous pourrez changer de configuration ultérieurement). 
