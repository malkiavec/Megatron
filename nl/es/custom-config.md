...
`"exclude_tag_attributes" : array` - Matriz de nombres de atributo HTML que la conversión elimina independientemente de la etiqueta HTML en la que se presentan. 

#### keep_tag_attributes

`"keep_tag_attributes" : array` - Matriz de nombres de atributo HTML que la conversión retiene. 
